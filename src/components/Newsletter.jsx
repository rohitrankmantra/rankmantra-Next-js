    ...
    <div data-aos="fade-down" className="text-[#7A6960]">
      ...
      >
        <input
          ...
          className="md:w-1/2 w-11/12 px-6 py-3 rounded-3xl outline-none border border-zinc-300 focus:border-red-600"
        />
        <button className="px-4 py-[10px] bg-red-600 hover:bg-red-800 rounded-3xl text-slate-50 text-lg hover:shadow hover:shadow-orange-500 transition-all duration-300">
          Subscribe
        </button>
      </form>
    </div>
