...
const WebsiteRedesignPage = () => {
  ...
  const heroImages = [
    "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1172&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=1170&auto=format&fit=crop",
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl mx-auto" data-aos="fade-up">
                  <h1 className="text-4xl md:text-6xl lg:text-7xl font-semibold text-gray-900 tracking-tight mb-8 leading-[1.1]">
                    Website <span className="text-red-600 font-light italic">Redesigning</span>
                  </h1>
                  <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
                    Revitalize your online presence with our comprehensive website redesign services. We modernize your site with current design trends, improved functionality, and better user experience to boost conversions.
                  </p>
                  <div className="mt-12">
      ...
      <section className="py-24 px-6 lg:px-20 bg-white border-b border-gray-50">
        <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
          ...
          <div className="space-y-8 text-gray-500 text-base md:text-lg max-w-3xl mx-auto leading-relaxed font-normal">
            <p>
              Is your website feeling outdated or failing to convert? RankMantra specializes in comprehensive website redesigns that transform your existing site into a powerful marketing tool.
            </p>
            <p>
              We don't just change the look; we improve the performance, restructure the content for better flow, and ensure your site meets modern web standards for speed, security, and mobile responsiveness.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          <div className="lg:w-1/2" data-aos="fade-right">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-sm border-[12px] border-white">
              <Image 
                src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?q=80&w=1000" 
                alt="Redesign Features" 
                fill 
          ...
          <div className="lg:w-1/2" data-aos="fade-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-500 text-base md:text-lg leading-relaxed font-normal">
              <ul className="space-y-4">
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> Modern design implementation</li>
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> Mobile responsiveness</li>
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> Performance optimization</li>
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> SEO improvement</li>
              </ul>
              <ul className="space-y-4">
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> Content restructuring</li>
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> User experience enhancement</li>
                <li className="flex items-center gap-3"><span className="w-2 h-2 bg-red-600 rounded-full"></span> Speed optimization</li>
              </ul>
            </div>
            <div className="pt-8">
