    ...
    <div className="secondary-font overflow-x-hidden bg-white selection:bg-red-50 selection:text-red-600">
      ...
      <section className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0 scale-105">
          <Image 
            ...
            alt="E-commerce Development Hero" 
            fill
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-20 text-center" data-aos="fade-up">
          <div className="inline-block px-6 py-2 mb-8 rounded-full bg-red-600/10 border border-red-600/20 backdrop-blur-md">
            <span className="text-red-600 text-xs font-bold tracking-[0.4em] uppercase">E-commerce Solutions</span>
          </div>
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-bold text-white tracking-tighter mb-8 leading-[1]">
            E-commerce <span className="text-red-600 font-light italic">Development</span>
          </h1>
          <p className="text-lg md:text-2xl text-gray-200 max-w-4xl leading-relaxed font-medium mb-12 mx-auto drop-shadow-2xl italic">
            RankMantra specializes in crafting custom web applications that help businesses unlock their full potential. Our expert team focuses on creating scalable, secure, and high-performance applications.
          </p>
      ...
      <section className="py-24 px-6 lg:px-20 bg-white border-b border-gray-50">
        <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
          <div className="space-y-8 text-gray-500 text-base md:text-lg max-w-6xl mx-auto leading-relaxed font-normal">
            <p>
      ...
      <section className="py-24 px-6 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              { title: "Mern Stack Development", icon: "🌐" },
              { title: "WordPress Development", icon: "📱" },
              { title: "PHP Development", icon: "💻" },
              { title: "Shopify Development", icon: "😊" },
              { title: "Wix Development", icon: "📈" }
            ].map((service, idx) => (
              <div key={idx} className="bg-gray-50 p-8 rounded-2xl flex flex-col items-center text-center hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            {[
              ...
              <div key={idx} className="w-16 h-16 rounded-full overflow-hidden border-2 border-white shadow-lg">
                <Image src={url} alt="Client" width={64} height={64} className="object-cover" />
              </div>
            ))}
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-8 leading-tight">
            100+ Ecommerce are Done by using the web Development Technologies
          </h2>
          <button className="bg-red-600 text-white font-bold py-3 px-8 rounded transition-all hover:bg-gray-900">
            CONTACT US
          </button>
        </div>
      </section>
...
export default EcommerceDevelopPage;
